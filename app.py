...
if st.session_state.perfil == "Admin":
    ...
    with menu[3]:
        ...
        cnpj = st.text_input("CNPJ:", value=str(dados_e['cnpj']) if dados_e is not None else "", key="e_cnpj")
        n_e = st.text_input("Nome:", value=str(dados_e['nome']) if dados_e is not None else "", key="e_nome")
