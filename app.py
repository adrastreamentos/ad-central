...
if st.session_state.perfil == "Admin":
    ...
    # === CLIENTES (COM BOTÕES SEPARADOS E RESET AUTOMÁTICO) ===
    with menu[2]:
        ...
        if opcao_cli == "Listar":
            ...
            if st.button("Salvar Novo Cliente"):
                ...
                if not nome or not pla_prin: st.error("Nome e ao menos 1 Placa de Veículo são obrigatórios.")
                    ...
                    # Limpeza de campos da sessão
                    for k in ["cli_inc_nome", "cli_inc_cpf", "cli_inc_tel", "cli_inc_end", "cli_inc_cid", "cli_inc_cep"]:
                        st.session_state[k] = ""
